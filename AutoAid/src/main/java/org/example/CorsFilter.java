...
*/
    ...
    private void setCorsHeaders(Response.ResponseBuilder response) {
        response.header("Access-Control-Allow-Origin", "https://auspicious-daffy-banjo.glitch.me");
    ...
    private void setCorsHeaders(ContainerResponseContext responseContext) {
        responseContext.getHeaders().add("Access-Control-Allow-Origin", "https://auspicious-daffy-banjo.glitch.me");
